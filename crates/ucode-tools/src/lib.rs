...
pub use git::{
    register_git_add_tool, register_git_branch_tool, register_git_checkout_tool,
    register_git_cherry_pick_tool, register_git_commit_tool, register_git_diff_commits_tool,
    register_git_diff_staged_tool, register_git_diff_tool, register_git_log_tool,
    register_git_merge_tool, register_git_rebase_tool, register_git_reset_tool,
    register_git_restore_tool, register_git_show_tool, register_git_stash_tool,
